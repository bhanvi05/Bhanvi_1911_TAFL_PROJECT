class TreeRenderer {
    ...
    _drawNodes(node, ox, oy) {
        ...
        if (node.symbol === 'ε') {
            this.ctx.fillStyle = '#EDEBE7';
            this.ctx.strokeStyle = '#D5CEC3';
        } else if (node.isTerminal) {
            this.ctx.fillStyle = '#E8EDE6';
            this.ctx.strokeStyle = '#A8B8A0';
        } else {
            this.ctx.fillStyle = '#EDE4F0';
            this.ctx.strokeStyle = '#7A6680';
        }
